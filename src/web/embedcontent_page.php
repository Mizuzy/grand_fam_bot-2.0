...
<body class="app">
  <aside class="sidebar">
    ...
    <nav class="nav">
      ...
      <a class="nav-link active" href="embedcontent_page.php">Embedcontent</a>
  ...
  <main class="content">
    ...
    <div class="list">
      <?php
      $res = $conn->query("SELECT ID, `event`, `header`, `content` FROM `embedcontent` ORDER BY ID ASC");
      ...
      ?>
        <button class="list-item as-link"
          ...
          <div class="left"><div class="title"><?php echo htmlspecialchars($row['event']); ?></div></div>
  ...
  <div id="modal" class="modal hidden" role="dialog" aria-modal="true">
    ...
    <div class="modal-card">
      <div class="modal-header">
        <h3 id="modal-title">Embed bearbeiten</h3>
