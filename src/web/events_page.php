...
<body class="app">
  <aside class="sidebar">
    ...
    <nav class="nav">
      ...
      <a class="nav-link active" href="events_page.php">Events</a>
  ...
  <main class="content">
    ...
    <div class="list">
      <?php
      $res = $conn->query("SELECT ID, `Event`, `Prio`, `MapID` FROM `events` ORDER BY ID ASC");
  ...
  <div id="modal" class="modal hidden" role="dialog" aria-modal="true">
    ...
    <div class="modal-card">
      <div class="modal-header">
        <h3 id="modal-title">Event bearbeiten</h3>
